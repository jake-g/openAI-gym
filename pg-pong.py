...
print ('event\tepisode\ttimestamp\treward\trunning_mean') # TSV output headers
...
while True:
  ...
  if done: # an episode finished
    ...
    print('episode\t%d\t%s\t%f\t%f' % (episode_number-1, datetime.isoformat(datetime.now()), reward_sum, running_reward))
